...
//recupriate the pervious page attribute
        ...
        addmag=(Button) findViewById(R.id.addmag);
        ...
        if(check.equals("true")&& checkk.equals("")){
            ...
            */
                ...
                public void onItemClick(AdapterView<?> adapterView, View view,  int i, long l) {
                    ...
                    alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "NO", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            SharedPreferences preferences = getSharedPreferences("checkBox", MODE_MULTI_PROCESS);
                            SharedPreferences.Editor editor = preferences.edit();
                    ...
                    Toast.makeText(getApplicationContext(), UNIT.get(i), Toast.LENGTH_LONG).show();
                    startActivity(intent2);
            ...
            addmag.setOnClickListener(new View.OnClickListener() {
                @Override
