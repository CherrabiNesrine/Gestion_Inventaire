...
public class DepenseAdapter extends RecyclerView.Adapter<DepenseAdapter.viewHolder> implements SingleChoiceDialogFragment.SingleChoiceListener{
    ...
    @Override
    public DepenseAdapter.viewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(final DepenseAdapter.viewHolder holder, final int position) {
    ...
    public void showDialog(final int pos) {
        ...
        mag= (TextView) dialog.findViewById(R.id.mag);
        ...
        before.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    java.util.Date updateLast = format.parse(DateCrea.getText().toString());
